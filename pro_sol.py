...
he_so = 100 # If price too small, need to multiply with he_so to correct the "i" loop below
SOL = 140 * he_so

# Load the dataset
data = pd.read_csv('data/SOL_15M.csv')
unit_price = round(SOL / 200) # 0.5% of current price
